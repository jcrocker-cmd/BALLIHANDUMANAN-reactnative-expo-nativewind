    ...
    <>
      ...
      <CollapsibleSubTitle name="BALILIHAN TODAY">
        ...
        <View className="mb-5 mt-2">
          ...
          <TouchableOpacity className="h-[180px] w-full overflow-hidden" onPress={handlePress(4)}>
          ...
          <TouchableOpacity className="h-[180px] w-full overflow-hidden" onPress={handlePress(6)}>
            <Image source={images[6]} className="h-full w-full" />
          </TouchableOpacity>
          <TouchableOpacity className="h-[180px] w-full overflow-hidden" onPress={handlePress(7)}>
        ...
        <Text className="text-balance py-1 text-justify font-inknut text-[12px] leading-[24px]">
          ...
          waterfalls and other scenic locations, and the restoration of historically significant
          sites to create appealing destinations for visitors.
        </Text>
        ...
        <Text className="text-balance py-1 text-justify font-inknut text-[12px] leading-[24px]">
          ...
          for Outstanding Anti-Drug Drive from the DILG, and in 2024, it was honored with
          the BansiwagGovernance Award for its Anti-Drug Abuse Council and Peace and Order Council.
        </Text>
