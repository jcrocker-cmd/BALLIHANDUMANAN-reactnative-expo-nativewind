    ...
    <>
      ...
      <CollapsibleSubTitle name="let’s do this!">
        ...
        <Text className="pb-5 pt-2 text-justify font-inknut text-[12px] leading-[24px] max-xs:text-base">
          ...
          "Balilihan sa Kahangturan." Now, armed with a deeper appreciation for the spirit of
          Balilihan as expressed in its hymn, let's explore its remarkable journey through the
