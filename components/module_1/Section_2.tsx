    ...
    <>
      ...
      <CollapsibleSubTitle name="let’s do this!">
        <Text className="py-2 text-justify font-inknut text-[12px] leading-[24px]">
          A. Before we delve into the lesson, let’s test your knowledge of our barangays with a fun
          activity called <Text style={{ color: '#0E8341' }}>“Guess that Barangay!</Text>
          {'\n'}• Head over to the Assessment & Activities. section of the app to participate.
          {'\n'}
          • Once you’ve finished, take a moment to reflect on what you’ve learned. Consider these
          guide questions:  {'\n'}
          {'\n'}
          ...
          {'\n'}
          {'\n'}
          B. Now that you've reflected on the "Guess that Barangay!" activity, it's time to put your
