    ...
    <>
      ...
      <CollapsibleSubTitle name="let’s do this!">
        <Text className="pb-5 pt-2 text-justify font-inknut text-[11px] leading-[24px]">
          ...
          app. This activity presents a series of photos showcasing Balilihan's cultural assets;
          guess the name of each heritage site.{'\n'}• Once you've completed the activity, we'll
          delve deeper into the stories behind these treasures with the following guide questions:
          {'\n'}
          ...
          that is?{'\n'}
          {'\n'}
          Now that you've tested your knowledge of Balilihan's cultural heritage with the "Uncover
          Balilihan's Treasures" activity, let's delve deeper! We'll explore the stories and
          significance of these treasured assets.
        </Text>
      </CollapsibleSubTitle>
    </>
  );
