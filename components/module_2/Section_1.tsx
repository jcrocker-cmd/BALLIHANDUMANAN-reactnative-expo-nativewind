  ...
  return (
    <>
      ...
      <CollapsibleSubTitle name="What I need to know?">
        <View style={{ flex: 1 }}>
          <Text className="mb-5 pt-2 text-justify font-inknut text-[11px] leading-[24px]">
            ...
            Spanish, American, and Japanese occupations, and analyze their impact on the lives and
