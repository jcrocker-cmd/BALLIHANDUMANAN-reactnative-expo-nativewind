    ...
    <>
      ...
      <CollapsibleSubTitle name="EXPLORE MORE!">
        <Text className="text-balance py-2 text-justify font-inknut text-[12px] leading-[24px]">
          ...
          development. Get ready to witness the resilience and progress of Balilihan in the years
          that followed. Proceed to the next chapter (Balilihan in the Postwar Era and Beyond)!
        </Text>
      </CollapsibleSubTitle>
    </>
  );
