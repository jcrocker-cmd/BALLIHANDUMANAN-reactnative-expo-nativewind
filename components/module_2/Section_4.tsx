    ...
    <>
      ...
      <CollapsibleSubTitle name={'BALILIHAN DURING SPANISH\nOCCUPATION'}>
        ...
        <Text className="py-2 text-justify font-inknut text-[11px] leading-[24px] max-xs:text-base">
          ...
          Tragically, Pongase's term was cut short when he was killed in a dispute.{'\n'}
          ...
          water by various springs such as Tan Pero, Ka Dadoy, Boho, Ka Boro, Bulingit, Bocboc,
          Komon, and Abaca.
        </Text>
        ...
        <Text className="text-balance py-1 text-justify font-inknut text-[11px] leading-[24px]">
          ...
          <Text style={{ color: '#0E8341' }}> Cabad</Text>, a barrio four kilometers west of
          poblacion. <Text style={{ color: '#0E8341' }}> Capitan Bartolome Racho</Text>, the current
          gobernadorcillo, fiercely resisted this relocation.
        </Text>
