      ...
      <CollapsibleSubTitle name="let’s do this!">
        <View style={{ flex: 1 }}>
          <Text className="pb-5 pt-2 text-justify font-inknut text-[12px] leading-[24px]">
            ...
            Get ready for "<Text style={{ color: '#0E8341' }}>Guess that Era!</Text>" • Head over to
            the Quiz/Activity section of the app to participate.{'\n'}
            ...
            we've warmed up our historical thinking skills, let's explore into the significant
            events that shaped Balilihan during the period of colonial occupation.
          </Text>
        </View>
      </CollapsibleSubTitle>
    </>
