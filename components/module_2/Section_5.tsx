    ...
    <>
      ...
      <CollapsibleSubTitle name="BALILIHAN DURING AMERICAN OCCUPATION">
        ...
        <Text className="text-balance py-1 text-justify font-inknut text-[12px] leading-[24px]">
          ...
          <Text style={{ color: '#0E8341' }}>Capitan Antonio</Text> Racho, municipal secretary 
          ...
          <Text style={{ color: '#0E8341' }}>Segundo Racho</Text>, the teenage son of Tan Tonio, who
          spoke on behalf of the welcoming party, the American officer remained unmoved, stating
        ...
        <View className="mb-1 mt-4 flex w-full flex-row items-start">
          <TouchableOpacity className="h-[200px] w-[40%] overflow-hidden" onPress={handlePress(2)}>
